...
keyword_freq_transposed.to_excel("C:\\workstation\\CPU\\CPU-2024\\대분류\\big_키워드빈도.xlsx")

# 바이그램 빈도 분석 결과를 EXCEL 파일로 저장
keyword_freq_bigrams_transposed.to_excel("C:\\workstation\\CPU\\CPU-2024\\대분류\\big_bigram_빈도분석.xlsx")
